...
<img src="https://raw.githubusercontent.com/Ethan-Ma/Learning_Blog/master/docs/olap/clickhouse/ck_granularity.jpg" width="50%" height="50%">
...
MergeTree引擎在查找数据时，整个过包括两个步骤：*读取压缩数据块*和*读取数据*;<br> 
 <img src="https://raw.githubusercontent.com/Ethan-Ma/Learning_Blog/master/docs/olap/clickhouse/mrk.jpg" width="50%" height="50%">
