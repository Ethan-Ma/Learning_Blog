...
![ck_granularity](./ck_granularity.jpg){:height="50%" width="50%"}
<img src="./ck_granularity.jpg" width="50%" height="50%">
...
![压缩数据块](./压缩数据块.jpg)
<img src="./压缩数据块.jpg" width="50%" height="50%">
...
MergeTree引擎在查找数据时，整个过包括两个步骤：*读取压缩数据块*和*读取数据*;<br> 
 ![mrk](./mrk.jpg)
 <img src="./mrk.jpg" width="50%" height="50%">
